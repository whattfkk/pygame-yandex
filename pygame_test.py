...
class main:
    ...
    def run(self):
        while True:
            ...
            #         pygame.quit()
            #         sys.exit()
            # self.screen.blit(pygame.image.load(self.walk_right[self.walk]).convert_alpha(), (50, 50))
            # if self.walk < 11:
            #     self.walk += 1
            # else:
            #     self.walk = 0
            ...
            self.screen.blit(pygame.image.load(self.flower[self.flower_go]).convert_alpha(), (50, 60))
            self.flower_go += 1
            if self.flower_go == 4:
                self.flower_go = 0
